package Course.E_CollectionsFramework.B_JavaCollections.G_Hash_and_HashMap;
...
public class Main {
    public static void main(String[] args) { 
        ...
        // 1a. deklarasi sebuah HashMap (Heterogeneous Data)
        HashMap<Object, Object> map = new HashMap<Object, Object>();
        HashMap temp = new HashMap();

        // 1b. deklarasi sebuah HashMap (Hmogeneous Data)
        // HashMap<[type of key], [type of value]> integerMap = new HashMap<[same], [same]>();
